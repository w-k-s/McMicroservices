...
var testS3Location = "s3://com.wks.mcmicroservices.kitchenservice/test/config.toml"
...
func (suite *ConfigS3TestSuite) Test_GIVEN_ValidS3UriString_WHEN_itIsParsed_THEN_bucketNameAndObjectKeyAreExtractedCorrectly() {
	// GIVEN
	uriString := "s3://com.wks.mcmicroservices.kitchenservice/toast/config.yml"
	...
	assert.Equal(suite.T(), "com.wks.mcmicroservices.kitchenservice", s3Uri.BucketName)
...
func (suite *ConfigS3TestSuite) Test_GIVEN_s3UriWithoutKey_WHEN_parseIsCalled_THEN_errorIsReturned() {
	// GIVEN
	uriString := "s3://com.wks.mcmicroservices.kitchenservice/"
...
func (suite *ConfigS3TestSuite) Test_GIVEN_s3UriIsProvided_WHEN_configFileDoesNotExistAtProvidedPath_THEN_errorIsReturned() {
	// GIVEN
	uri := "s3://com.wks.mcmicroservices.kitchenservice/toast/config.yml"
